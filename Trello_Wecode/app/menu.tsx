    ...
    <KeyboardAvoidingView className="flex-1 bg-gray-100 p-3" >
      <ScrollView horizontal={true} className="space-x-3">
        ...
        <View className="flex-row items-start gap-5  bg-gray-100 rounded-xl p-3">
          <View className="bg-black rounded-xl p-3 w-64">
            ...
            {!inputTask ? (
              <TouchableOpacity onPress={() => setInputTask(true)} className="flex flex-row items-center mt-2">
                <Text className="text-xl text-gray-700 text-white">+</Text>
                <Text className="text-gray-700 ml-1 text-white">Add a card</Text>
              </TouchableOpacity>
            ) : (
              <View className="flex flex-row items-center mt-2">
                <TextInput value={textTask} onChangeText={setTextTask} placeholder="Card name..." placeholderTextColor="#999" className="flex-1 bg-gray-100 border border-gray-300 px-3 py-2 rounded-lg text-black"/>
          ...
          <View className="bg-black rounded-xl p-3 w-64">
            ...
            {!inputProcess ? (
              ...
              <View className="flex flex-row items-center mt-2">
                <TextInput value={textInProcess} onChangeText={setTextInProcess} placeholder="Card name..." placeholderTextColor="#999" className="flex-1 bg-gray-100 border border-gray-300 px-3 py-2 rounded-lg text-black"/>
          ...
          <View className="bg-black rounded-xl p-3 w-64">
            ...
            {!inputToDo ? (
              ...
              <View className="flex flex-row items-center mt-2">
                <TextInput value={textToDo} onChangeText={setTextToDo} placeholder="Card name..."  placeholderTextColor="#999"  className="flex-1 bg-gray-100 border border-gray-300 px-3 py-2 rounded-lg text-black" />
        ...
        <View className="bg-blue-600 rounded-xl p-3 h-[80px] ">
          {!inputOrg ? (
            ...
            <View className="flex flex-row items-center mt-2">
              <TextInput value={textOrg}  onChangeText={setTextOrg}  placeholder="Organization name..."  placeholderTextColor="#999"  className="flex-1 bg-gray-100 border border-gray-300 px-3 py-2 rounded-lg text-black" />
              <TouchableOpacity
                onPress={() => { setTextOrg("");
