...
export default function DrawerExample() {
  ...
  const renderScreen = () => {
    ...
    if (currentScreen === "Boards") return <Text>Boards Screen</Text>;
    if (currentScreen === "Organisation") return <Text>Organisation Screen</Text>;
    ...
    <Drawer
      ...
      renderDrawerContent={() => (
        <View className="flex-1 bg-white p-6">
          ...
          <TouchableOpacity onPress={() => { setCurrentScreen("Organisation"); setOpen(false); }}>
            <Text className="text-base mb-3"> Organisation</Text>
          </TouchableOpacity>
